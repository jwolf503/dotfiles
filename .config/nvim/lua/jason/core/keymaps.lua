...
keymap.set("n", "<leader>sh", "<C-w>s", { desc = "Split wondow horizontally" }) -- split window horizontal
keymap.set("n", "<leader>se", "<C-w>=", { desc = "Make split equal size" }) -- equalize split
